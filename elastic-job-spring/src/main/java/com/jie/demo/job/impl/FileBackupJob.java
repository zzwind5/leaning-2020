...
public class FileBackupJob implements SimpleJob {
    ...
    static {
        for(int i=1;i<11;i++){
            FileBackupJob.files.add(new FileCustom(i+10,"文件"+(i+10),"text", false, "content"+ (i+10)));
            FileBackupJob.files.add(new FileCustom(i+20,"文件"+(i+20),"image", false,"content"+ (i+20)));
            FileBackupJob.files.add(new FileCustom(i+30,"文件"+(i+30),"radio",false,"content"+ (i+30)));
            FileBackupJob.files.add(new FileCustom(i+40,"文件"+(i+40),"video",false,"content"+ (i+40)));
        }
